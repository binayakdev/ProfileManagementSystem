...
<!DOCTYPE html>
        ...
        <body>
            ...
            <div class="main">
                <div class="image">
                    <img style = "height:100%; width:100%;" src="image2.jpeg" alt="background">  
                    <div class="shade"></div>
                    <p class="banner">Teachers</p> 
                </div>
                <div class="registration">
                    <form style="padding:40px 40px 40px 40px;" action="insert_db.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input class="custom" type="text" name="address" placeholder="Address" required>
                            <select class="custom" name="department""> 
                                <option style="color:grey;">Computing
                                <option style="color:grey;">Networking
                                <option style="color:grey;">Multi-Media
                            </select>
                            <?php if (isset($_SESSION["format_error"])) { ?>
                                <span style="color:red;"><?=$_SESSION["format_error"]?></span>
                            <?php } 
                                $_SESSION["format_error"] = "";?>
                            <input style="margin-top: 1em;" class="custom" type="text" name="salary" placeholder="Enter Salary Amount" required>
