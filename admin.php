					...
					<div class="info">
						<div style="width:100%; height:30%; background:url('details.jpg') 100px 110px; ">
							<div style="background:#f7f7f7; height:130%; width:20%; margin-left:5%; margin-top:5%; padding:1% 1% 1% 1%;">
								<img style="width:100%; height:100%;" src="profile.jpg" alt="you">
							</div>
						</div>
						<div style="background:#dfe3ee; height:35%; width:90%; box-shadow:1px 1px 5px black; margin-top:2%; margin-left:5%;border-radius:2px; padding-bottom: 20px;">
								...
								<div class="content" style="padding-left:20px;"><h3>Email:<?=$row["name"];?></h3></div>
								<div class="content" style="padding-left:20px;"><h3>User:<?=$row["type"];?></h3></div>
								<div class="content" style="padding-left:20px;"><h3>ID:<?=$row["id"];?></h3></div><br>
								<a href="student_data.php"><button style="margin-left:25%;" class="button">View Student Data</button></a>
								<a href="teacher_data.php"><button class="button">View Teacher Data</button></a>
						</div>
					</div> 
		<?php
			}
