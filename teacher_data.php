	...
	<?php if (isset ($_SESSION["infos"])){ ?>
		<?php
			...
			$result = mysqli_query($connectivity,$query);
				...
				<div class="database">
						<a href="Registration_teacher.php"><button class="button">Add User</button></a>
						<a href="t_delete.php"><button class="button">Delete Account</button></a>
						<a href="t_update.php"><button class="button">Update Account</button></a>		
					...
					while ($row = mysqli_fetch_assoc($result)){
						$baseurl="http://localhost/xampp/htdocs/workspace/Login Portal";
